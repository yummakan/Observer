...
create_generated_clock -name {PLL|altpll_component|auto_generated|pll1|clk[3]} -source [get_pins {PLL|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 12 -master_clock {CLOCK_50} [get_pins {PLL|altpll_component|auto_generated|pll1|clk[3]}] 
